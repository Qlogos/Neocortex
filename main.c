...
#define CELL_SIZE   20              /* screen pixels per MNIST pixel    */
#define GRID_W      28
#define GRID_H      28
#define NUM_PIXELS  (GRID_W * GRID_H)
...
int main(void) {
    ...
    u32 fired[NUM_PIXELS];      /* worst-case: every pixel fires    */
    u32 image_idx = 0;
    ...
    while (!WindowShouldClose()) {
        ...
        for (u32 i = 0; i < NUM_PIXELS; i++) {
            ...
            DrawRectangle((int)(col * CELL_SIZE), (int)(row * CELL_SIZE),
